...
export function Tables() {
  ...
  const [user,setUser] = useState({id:'',email:'', name: '', password: '',subject:'', homeroom: ""})
      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            ...
            <tbody>
              {data.map(
                ({id,name, email, subject, homeroom}, key) => {
                  ...
                  return (
                    <tr key={name}>
                      ...
                      <td className={className}>
                        <Typography
                          as="button"
                          onClick={()=>{setShow(true);setUser({...user,id:id,email:email, name: name, subject:subject, homeroom: homeroom})}}
